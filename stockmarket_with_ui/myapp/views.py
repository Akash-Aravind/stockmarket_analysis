...
def home(request):
    ...
    return render(request, 'index.html',{"companies":top_100_companies})
...
def currentprice(request, ticker):
    ...
    return render(request, 'display_ticker.html', {'ticker': ticker,'value':value,'net_change':net_change,'percentage_change':percentage_change,'time':timee})


from datetime import datetime, timedelta

def pricehistory(request, ticker):
    ...
    return render(request, 'makeprediction.html', {'ticker': ticker, 'value': predicted_close_25_aug, 'datee': datee})
